...
public class FastContextAnnotator extends JCasAnnotator_ImplBase {
    ...
    private Logger mLogger = LoggerFactory.getLogger( FeatureGen.class );
    ...
    FastContext fcEngine;
        ...
        public void process(JCas cas) throws AnalysisEngineProcessException
        {
                ...
                for( Sentence current_sentence : sentences ){
                    ...
                    mLogger.debug( "Sentence:    " + sentenceText );
                    mLogger.debug( "Token Spans: " + sentenceTokenSpans.toString() );
...
//                      mLogger.debug( "\t|" + original_concept.getCoveredText() + "|" + 
////                                   sentenceText.substring( conceptRelativeBegin , 
////                                                           conceptRelativeEnd ) + "|" );
...
//                                   String.valueOf(  ) );
                        ...
                        // - genericValue = "true"
                        if( contextAttributes.get( "his" ).equalsIgnoreCase( "historical" ) ){
                        historicalValue = "-1";
                        ...
                        historicalValue = "1";
                            ...
                            polarityValue = "-1";
                        } else if( contextAttributes.get( "exp" ).equalsIgnoreCase( "nonpatient" ) ){
